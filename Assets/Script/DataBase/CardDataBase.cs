...
public class CardDataBase : MonoBehaviour
{
    ...
    public void InitializeList() // Creating all the cards with data on it
    {
        ...
        AllCardsInGame = new List<Card>()
        {
            ...
            new Card(101, "SunnySideEgg" , 100, "A " , gA.SunnySideEgg, CardType.Food, Rarity.Normal),
            new Card(102, "Ramen" , 300, "Seems Like Soup A Ramen \n+10 Atk " , gA.Ramen, CardType.Food, Rarity.Rare),
            new Card(103, "Sandwich" , 300, "Usually Breakfast \n+3 Atk Spd " , gA.Sandwich, CardType.Food, Rarity.Rare),
            new Card(201, "Dynamite" , 100, "One time use, Deploy a Dynamite during Gameplay Phase, it dealts an Aoe damage to enemy who in Range" , gA.Dynamite, CardType.Item, Rarity.Normal),
            new Card(202, "Amulet Coin" , 1000, "Gain extra coins by killing enemy" , gA.AmuletCoin, CardType.Item, Rarity.SuperRare),
            new Card(203, "Red Cape" , 500, "Allow character dealt extra fire damage" , gA.RedCape, CardType.Item, Rarity.Rare),
            new Card(204, "Speed Up Boots" , 1200, "Grant extra speed when equipped" , gA.SpeedUpBoots, CardType.Item, Rarity.SuperRare),
            new Card(205, "Ultimate Armour" , 25000, "The most powerful armour in the game" , gA.UltimateArmour, CardType.Item, Rarity.UltraRare),
            new Card(301, "StarKnight" , 1, "Star's Partner Summon" , gA.StarKnight, CardType.Summon, Rarity.SummonRare),
            new Card(302, "NeptuneDragon" , 1, "Neptune's Partner Summon" , gA.StarKnight, CardType.Summon, Rarity.SummonRare),
        };
    }
